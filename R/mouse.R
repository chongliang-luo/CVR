...
#'       \url{http://www.genetics.org/cgi/content/full/genetics.110.116087/DC1}}
#'   \item{expr}{Mouse gene expression. A data frame of 294 rows and 215 columns.
#'       \url{ftp://ftp.ncbi.nlm.nih.gov/pub/geo/DATA/SeriesMatrix/GSE2814/}}
#'   \item{bmi}{Mouse body-mass index. A data frame of 294 rows and 1 column.
#'       \url{http://labs.genetics.ucla.edu/horvath/CoexpressionNetwork/MouseWeight/}}
#' }
#' 
#' @examples
